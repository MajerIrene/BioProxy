...
In the elbow plot, we can see that the value for the RMSE oscillate between lower and higher value, without reaching a defined plateau. This could be a sign of overfitting.
